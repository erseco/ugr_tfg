...
Para optimizar el ataque incluimos como parámetro una expresión regular que se centra en obtener la variable de sesión de moodle para así reducir el tamaño de las capturas, si la plataforma es vulnerable podremos ver la variable de sesión \textbf{MOODLEID1\_} en cuanto un usuario se identifique en la página.
