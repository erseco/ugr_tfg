...
Tras analizar los registros proporcionados por el CEVUG de los años 2015 y 2016 vemos que los resultados de la encuesta cuadran con los mismos. Hay que tener en cuenta que solo se tienen registros hasta el 31 de Diciembre de 2016, por lo que los datos del curso 2016/2017 seguramente se duplicarán.

\ref{fig:distintonumerousuarios}.

Lo primero a destacar son el incremento de peticiones del año 2015 al año 2016 que se puede apreciar en la tabla de la figura \ref{table:sumarioregistros}, seguramente debido a la campaña de aviso de cambio de plataforma por parte del CEVUG en 2015.
...
En cuanto a las actividades podemos ver en las figuras \ref{fig:usoactividades_2015} y \ref{fig:usoactividades_2016} así como en la tabla \ref{table:usoactividades_2015} que tal y como concluimos en la encuesta la gran mayoría de las actividades disponibles en moodle no tienen apenas uso. 
