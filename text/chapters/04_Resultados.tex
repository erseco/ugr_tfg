...
\bigskip
En cuanto a actividades, podemos ver que, al igual que en las instalaciones de \textit{moodle} de otras universidades, las opciones mas usadas son las de agregar tareas y archivos, hay que tener en cuenta que hay actividades que básicamente son similares a agregar archivo, como puede ser carpeta, documento, página y libro.

\bigskip
Aunque \textit{moodle} tiene actividades que podrían ser muy útiles, como pueden ser los paquetes SCORM e IMS, el desconocimiento y/o la falta de formación hace que la gente ignore para que sirven.
...
Tras analizar los registros proporcionados por el \textit{CEVUG} de los años 2015 y 2016 vemos que los resultados de la encuesta cuadran con los mismos. Hay que tener en cuenta que solo se tienen registros hasta el 31 de Diciembre de 2016, por lo que los datos del curso 2016/2017 seguramente se duplicarán.

\ref{fig:distintonumerousuarios}.

Lo primero a destacar son el incremento de peticiones del año 2015 al año 2016 que se puede apreciar en la tabla de la figura \ref{table:sumarioregistros}, seguramente debido a la campaña de aviso de cambio de plataforma por parte del \textit{CEVUG} en 2015.
...
En cuanto a las actividades podemos ver en las figuras \ref{fig:usoactividades_2015} y \ref{fig:usoactividades_2016} así como en la tabla \ref{table:usoactividades_2015} que tal y como concluimos en la encuesta la gran mayoría de las actividades disponibles en \textit{moodle} no tienen apenas uso.
