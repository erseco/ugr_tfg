...
\begin{itemize}
	\item Activar los servicios web XML de \textit{moodle} y utilizar el código fuente de las aplicación Android e iOS propias de \textit{moodle} para desarrollar unas versiones propias que hagan uso del \textit{IDP} del \texit{CSIRC}.
\begin{figure}[H]
\centering
